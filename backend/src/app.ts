...
// Bu dosya sadece Express app'ini kurar (middleware + route mount) — MongoDB bağlantısı,
// Steam bot başlatma ve app.listen() bilinçli olarak burada YOK. Bu ayrım sayesinde testler
// (supertest) gerçek bir sunucu ayağa kaldırmadan/gerçek Mongo'ya bağlanmadan `app`'i import edip
// kullanabilir. Gerçek sunucu bootstrap'i `index.ts`'te.
const app = express();
